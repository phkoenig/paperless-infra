/**
 * Gmail zu Paperless Export Script - FINALE VERSION v2
 * 
      ...
      if (relevantAttachments.length > 0) {
        try {
          ...
          const metadata = {
            ...
            exportedBy: 'Paperless-Email-Export-Script-v2'
          };
...
function setupPaperlessExport() {
  console.log('🔧 Setup Paperless Export v2...');
  ...
  console.log('✅ Setup v2 abgeschlossen');
}
 ...
 */
function testExport() {
  console.log('🧪 Test-Modus aktiviert (v2)');
  exportToPaperless();
}
